...
async def event_search() -> None:
    results: list[dict] = []
    selected_idx = 0

    with ui.element("div").classes("flex items-center w-120"):
                    ...
                    for i, item in enumerate(results):
                        ...
                        with (
                            ...
                            with ui.element("q-item-section"):
                                ...
                                with ui.row().classes("items-center gap-2 no-wrap"):
                                    ui.icon("fingerprint").classes("text-grey-6 text-s")
                            ...
                            with (
                                ...
                                if item["magnitude"] is not None:
                                    ...
                                    ui.label("S ").classes("text-s text-grey-6 italic")
        ...
        with (
            ...
            .classes("w-full search-event-input")
